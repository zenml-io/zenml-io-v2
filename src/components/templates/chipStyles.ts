 ...
 *
 * One source for the per-variant background/text classes so MetadataBlock's
 * chips and RelatedRail's tag chips cannot drift apart. Only the colors are
 * shared — each consumer keeps its own base shape classes (radius/padding
