---
title: "Multi-Company Panel Discussion on Production LLM Frameworks and Scaling Challenges"
slug: "multi-company-panel-discussion-on-production-llm-frameworks-and-scaling-challenges"
draft: false
webflow:
  siteId: "64a817a2e7e2208272d1ce30"
  itemId: "68622e69a8536c575809decf"
  exportedAt: "2026-02-11T10:23:34.071Z"
  source: "live"
  lastPublished: "2025-12-23T12:21:17.478Z"
  lastUpdated: "2025-12-18T17:12:51.828Z"
  createdOn: "2025-06-30T06:27:53.297Z"
llmopsTags:
  - "code-generation"
  - "healthcare"
  - "data-analysis"
  ...
  - "openai"
  - "anthropic"
company: "Various (Thinking Machines, Yutori, Evolutionaryscale, Perplexity, Axiom)"
summary: "This panel discussion features experts from multiple AI companies discussing the current state and future of agentic frameworks, reinforcement learning applications, and production LLM deployment challenges. The panelists from Thinking Machines, Perplexity, Evolutionary Scale AI, and Axiom share insights on framework proliferation, the role of RL in post-training, domain-specific applications in mathematics and biology, and infrastructure bottlenecks when scaling models to hundreds of GPUs, highlighting the gap between research capabilities and production deployment tools."
link: "https://www.youtube.com/watch?v=zH-X7d-OlBI"
year: 2025
seo:
  title: "Various (Thinking Machines, Yutori, Evolutionaryscale, Perplexity, Axiom): Multi-Company Panel Discussion on Production LLM Frameworks and Scaling Challenges - ZenML LLMOps Database"
  description: "This panel discussion features experts from multiple AI companies discussing the current state and future of agentic frameworks, reinforcement learning applications, and production LLM deployment challenges. The panelists from Thinking Machines, Perplexity, Evolutionary Scale AI, and Axiom share insights on framework proliferation, the role of RL in post-training, domain-specific applications in mathematics and biology, and infrastructure bottlenecks when scaling models to hundreds of GPUs, highlighting the gap between research capabilities and production deployment tools."
  canonical: "https://www.zenml.io/llmops-database/multi-company-panel-discussion-on-production-llm-frameworks-and-scaling-challenges"
  ogTitle: "Various (Thinking Machines, Yutori, Evolutionaryscale, Perplexity, Axiom): Multi-Company Panel Discussion on Production LLM Frameworks and Scaling Challenges - ZenML LLMOps Database"
  ogDescription: "This panel discussion features experts from multiple AI companies discussing the current state and future of agentic frameworks, reinforcement learning applications, and production LLM deployment challenges. The panelists from Thinking Machines, Perplexity, Evolutionary Scale AI, and Axiom share insights on framework proliferation, the role of RL in post-training, domain-specific applications in mathematics and biology, and infrastructure bottlenecks when scaling models to hundreds of GPUs, highlighting the gap between research capabilities and production deployment tools."
---
