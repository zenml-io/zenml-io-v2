...
openGraphImage:
  url: "https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/d6da930a/66c5fcef7b3dd4887449bc45_compare-hf.png"
blocks:
  - kind: "value"
  ...
  - kind: "cta02"
    headline: "Streamline Your MLOps Workflow with ZenML and Hugging Face Integration"
    bullets:
...
hero:
  ...
  deck: "While Hugging Face excels as a platform for model sharing and collaboration, ZenML offers a comprehensive MLOps framework that complements Hugging Face's capabilities. Discover how ZenML's intuitive pipeline definition, experiment tracking, and model and data versioning features streamline your end-to-end machine learning workflows. Leverage ZenML's seamless integration with Hugging Face for model deployment and artifact materialization, and explore ZenML's deployment option on the Hugging Face Hub as a Space for enhanced collaboration. Learn how ZenML and Hugging Face work together to empower you to build, deploy, and manage state-of-the-art models with ease."
  primaryCta:
    label: "Book a demo"
    href: "/book-your-demo"
  secondaryCta:
...
seo:
  ...
  ogImage: "https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/281622b8/66c5fcef7b3dd4887449bc45_compare-hf.png"
