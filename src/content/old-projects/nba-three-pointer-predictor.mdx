...
<ul id=""><li id=""><strong id="">Data Validation</strong> - Check for train-test data drift using Evidently.</li><li id=""><strong id="">Training</strong> - Train models with Scikit-learn and track experiments using MLflow.</li><li id=""><strong id="">Inference</strong> - Run inference on new data and posts notification on Discord.</li></ul>
...
<ul id=""><li id=""><strong id="">Orchestrator</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/orchestrators/kubeflow" id="">Kubeflow Pipelines</a>.</li><li id=""><strong id="">Artifact Store</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/artifact-stores/s3" id="">Amazon S3</a>.</li><li id=""><strong id="">Container Registry</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/container-registries/aws" id="">Amazon Elastic Container Registry</a>.</li><li id=""><strong id="">Secret Manager</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/secrets-managers/aws" id="">AWS Secret Manager</a>.</li><li id=""><strong id="">Experiment Tracker</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/experiment-trackers/mlflow" id="">MLflow</a>.</li><li id=""><strong id="">Data Validator</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/data-validators/evidently" id="">Evidently</a>.</li><li id=""><strong id="">Alerter</strong> - <a href="https://discord.com/" id="">Discord</a>.</li></ul>
