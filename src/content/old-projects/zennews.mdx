...
<ul id=""><li id=""><strong id="">Orchestrator</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/orchestrators/local" id="">Local Orchestrator</a>.</li><li id=""><strong id="">Artifact Store</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/artifact-stores/local" id="">Local Artifact Store</a>.</li></ul>

**Remote Stack with Scheduled Pipelines**:

<ul id=""><li id=""><strong id="">Orchestrator</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/orchestrators/vertex" id="">Vertex Orchestrator</a>.</li><li id=""><strong id="">Artifact Store</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/artifact-stores/gcp" id="">GCS Artifact Store</a>.</li><li id=""><strong id="">Secret Manager</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/secrets-managers/gcp" id="">GCP Secrets Manager</a>.</li><li id=""><strong id="">Container Registry</strong> - <a href="https://docs.zenml.io/user-guide/component-guide/container-registries/gcp" id="">GCP Container Registry</a>.</li><li id=""><strong id="">Alerter</strong> - <a href="https://github.com/zenml-io/zenml-projects/blob/main/zen-news-summarization/src/zennews/alerter/discord_alerter.py" id="">Discord Alerter (part of the zennews package)</a>.<br></li></ul>
