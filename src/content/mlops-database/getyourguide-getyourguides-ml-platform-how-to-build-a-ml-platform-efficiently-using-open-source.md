---
title: "How to Build a ML Platform Efficiently Using Open-Source"
slug: "getyourguide-getyourguides-ml-platform-how-to-build-a-ml-platform-efficiently-using-open-source"
draft: false
mlopsTags:
  - "experiment-tracking"
  - "feature-store"
...
contentType: "video"
summary: "Unfortunately, the provided source content does not contain the actual technical content from GetYourGuide's presentation on building an ML platform using open-source tools. The source text only shows a YouTube cookie consent page with language selection options, rather than the substantive material about their ML platform architecture, implementation details, or MLOps practices. Without access to the actual presentation transcript, video content, or accompanying technical documentation, it is impossible to provide a meaningful analysis of GetYourGuide's approach to building their ML platform, the specific open-source technologies they employed, the architectural decisions they made, or the results they achieved."
link: "https://www.databricks.com/session_na21/how-to-build-a-ml-platform-efficiently-using-open-source"
year: 2022
seo:
  title: "GetYourGuide: How to Build a ML Platform Efficiently Using Open-Source - ZenML MLOps Database"
  description: "Unfortunately, the provided source content does not contain the actual technical content from GetYourGuide's presentation on building an ML platform using open-source tools. The source text only shows a YouTube cookie consent page with language selection options, rather than the substantive material about their ML platform architecture, implementation details, or MLOps practices. Without access to the actual presentation transcript, video content, or accompanying technical documentation, it is impossible to provide a meaningful analysis of GetYourGuide's approach to building their ML platform, the specific open-source technologies they employed, the architectural decisions they made, or the results they achieved."
  canonical: "https://www.zenml.io/mlops-database/getyourguide-getyourguides-ml-platform-how-to-build-a-ml-platform-efficiently-using-open-source"
  ogTitle: "GetYourGuide: How to Build a ML Platform Efficiently Using Open-Source - ZenML MLOps Database"
  ogDescription: "Unfortunately, the provided source content does not contain the actual technical content from GetYourGuide's presentation on building an ML platform using open-source tools. The source text only shows a YouTube cookie consent page with language selection options, rather than the substantive material about their ML platform architecture, implementation details, or MLOps practices. Without access to the actual presentation transcript, video content, or accompanying technical documentation, it is impossible to provide a meaningful analysis of GetYourGuide's approach to building their ML platform, the specific open-source technologies they employed, the architectural decisions they made, or the results they achieved."
mlops:
  source: "sqlite"
  entryId: 123
