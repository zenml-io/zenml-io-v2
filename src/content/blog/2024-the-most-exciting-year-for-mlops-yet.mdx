...
<ul start="1" id=""><li id="">Try a quick PoC with RAG.</li><li id="">Realize it's good in 80% of use-cases, but not quite there yet.</li><li id="">Think about improvements - start from reranking and go all the way to automated evaluation and finetuning.</li><li id="">Find yourself in chaos because you just ran through a whirlwind of manual processes. Go back. Automate and repeat.</li></ul>
