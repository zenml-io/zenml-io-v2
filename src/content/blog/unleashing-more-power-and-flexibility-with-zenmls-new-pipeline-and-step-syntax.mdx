...
<div data-rt-embed-type="true"><pre><code>from zenml.steps.external_artifact import ExternalArtifact

@pipeline
def my_pipeline(lr: float):
 &nbsp; &nbsp;data = process_data()
 &nbsp; &nbsp;trainer(data=data, start_model=ExternalArtifact(svc.SVC(...)))</code></pre></div>
...
<div data-rt-embed-type="true"><pre><code>@pipeline(enable_cache=False)
...
<div data-rt-embed-type="true"><pre><code>my_pipeline(lr=0.000001)
</code></pre></div>
...
<div data-rt-embed-type="true"><pre><code>
</code></pre></div>
...
<div data-rt-embed-type="true"><pre><code>from zenml import step, pipeline
</code></pre></div>
