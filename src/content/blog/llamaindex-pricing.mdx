...
<div data-rt-embed-type="true"><div class="table-container">
  ...
  <title>LlamaIndex Pricing Table</title>
  <style>
    table.pricing-table {
      width: 100%;
  ...
  <table class="pricing-table">
    ...
    <tbody>
      <tr>
        ...
        <td>$0</td>
        <td>
          – Self-hosted library (free to use)<br>
          – Includes 10K credits on LlamaIndex Cloud per month<br>
          – 1 user, file uploads only (no external data connectors)<br>
          – Basic community support
        </td>
        <td>Developers and teams who want maximum control and are willing to manage their own infrastructure.</td>
      </tr>
      <tr>
        <td>Starter</td>
        <td>$50 per month</td>
        <td>
          – Includes 50K credits/month (up to 500K credits pay-as-you-go)<br>
          – 5 users included<br>
          – Connect up to 5 external data sources (Google Drive, S3, etc.)<br>
          – Basic support
        </td>
        <td>Individuals or small teams starting with managed services for prototyping and small-scale applications.</td>
      </tr>
      <tr>
        <td>Pro</td>
        <td>$500 per month</td>
        <td>
          – Includes 500K credits/month<br>
          – 10 users included<br>
          – Up to 25 external data sources<br>
          – Basic support
        </td>
        <td>Growing teams and businesses deploying production applications with moderate to heavy usage.</td>
      </tr>
      <tr>
        <td>Enterprise</td>
        <td>Custom</td>
        <td>
          – Custom credits, limits, and pricing (negotiated)<br>
          – Unlimited users, indexes, and data sources<br>
          – Enterprise-only features (advanced security, SSO, etc.)<br>
          – Deployment in SaaS or your VPC, with dedicated support
        </td>
        <td>Large organizations with stringent security, compliance, and scalability requirements for mission-critical AI agents.</td>
      </tr>
      <tr>
        <td>LlamaParse</td>
        <td>Pay-per-use (credits)</td>
        <td>Parsing documents; pricing depends on mode (e.g., ~3–90 credits per page)</td>
        <td>Developers needing structured parsing</td>
      </tr>
      <tr>
        <td>LlamaExtract</td>
        <td>Pay-per-use (credits)</td>
        <td>Schema-based extraction; 5–60 credits per page depending on mode</td>
        <td>Teams extracting structured data at scale</td>
      </tr>
    </tbody>
  </table>
...
<div data-rt-embed-type="true"><div class="table-container">
  ...
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Parsing Mode Pricing Table</title>
  <style>
    table.parse-table {
      width: 100%;
      border-collapse: collapse;
  ...
  <table class="parse-table">
    <thead>
      <tr>
        <th>Parsing Mode/Model</th>
        <th>Credits per Page</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>Parse without AI</td>
        <td>1</td>
      </tr>
      <tr>
        <td>Parse page with LLM (Cost-effective)</td>
        <td>3</td>
      </tr>
      <tr>
        <td>Parse page with Gemini-1.5-flash</td>
        <td>15</td>
      </tr>
      <tr>
        <td>Parse page with OpenAI-GPT-4</td>
        <td>30</td>
      </tr>
      <tr>
        <td>Parse page with Agent (Gemini-2.5-pro)</td>
        <td>45</td>
      </tr>
      <tr>
        <td>Parse page with Agent (Anthropic-Sonnet-4.0)</td>
        <td>90</td>
      </tr>
    </tbody>
  </table>
...
<ul id=""><li id="">On the free cloud plan, you can only upload files directly for ingestion; no connectors to external data sources or cloud storage.</li><li id="">You can create up to 5 indexes with up to 50 documents each – enough to toy around, but not for a production workload.</li><li id="">Support is basic, meaning community forums or documentation (don’t expect a support engineer on call).</li></ul>
...
<ul id=""><li id="">50,000 monthly credits included (your subscription essentially prepays $50 worth of usage).</li><li id="">Pay-as-you-go: up to 500,000 credits per month at $0.001 per credit before requiring a Pro upgrade.</li><li id="">Up to 5 users in a shared cloud workspace (vs. 1 on Free).</li><li id="">Lets you integrate with 50+ external data sources like S3, Google Drive, SharePoint, and more. (max 5 connectors allowed).</li><li id="">50 indexes allowed (vs. 5 on Free).</li><li id="">250 files per index capacity.</li><li id="">Up to 5 concurrent extraction agents (special agents for automated data extraction).</li><li id="">Cloud-based collaboration features suitable for small teams/startups.</li></ul>
...
<ul id=""><li id=""><a href="https://www.zenml.io/blog/crewai-pricing" id="">CrewAI pricing</a></li><li id=""><a href="https://www.zenml.io/blog/langgraph-pricing" id="">LangGraph pricing</a></li><li id=""><a href="https://www.zenml.io/blog/clearml-pricing" id="">ClearML pricing</a></li><li id=""><a href="https://www.zenml.io/blog/prefect-pricing" id="">Prefect pricing</a></li></ul>
