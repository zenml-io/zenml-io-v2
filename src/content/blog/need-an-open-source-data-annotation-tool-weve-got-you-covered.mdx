...
<ul id=""><li id="">The tool needs to have an open-source license.</li><li id="">The tool needs to be actively maintained. (Someone’s hobby project from 5 years ago probably isn’t going to be of much use in a production environment in 2022.)</li><li id="">The tool should be functional and fit for purpose.</li></ul>
