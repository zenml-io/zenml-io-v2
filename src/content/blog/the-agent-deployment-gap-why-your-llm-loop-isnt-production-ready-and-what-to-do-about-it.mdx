...
<div data-rt-embed-type="true"><pre><code>while not task_complete:
...
<div data-rt-embed-type="true"><div style="background-color: #f5f5f5; border-left: 3px solid #ddd; padding: 16px; margin: 20px 0; font-size: 14px;">
