...
<ol id=""><li id="">Automate processing and provisioning</li><li id="">Version-control states and instructions</li><li id="">Write declarative configs</li></ol>
...
<ul id=""><li id="">Splitting happens on a quota, e.g. 70% into train, 30% into eval. Data might be sorted on an index, data might be categorized.</li><li id="">Splitting happens based on features/columns. Data might be categorized, Data might be sorted on an index.</li><li id="">Data might require preprocessing / feature engineering (e.g. filling, standardization).</li><li id="">A wild mix of the above.</li></ul>
