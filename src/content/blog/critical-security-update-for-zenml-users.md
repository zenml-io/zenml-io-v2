...
<ul><li>For direct installations, use pip install "zenml==0.46.7" (or the respective patched version). (Note that the current latest version is 0.55.2, released last week.)</li><li>For containerized or orchestrated environments, update your ZenML container image or deployment configuration to use the new version.</li><li>Ensure that any automated deployment pipelines are also updated accordingly.</li></ul>
