...
def a_loading_data_step() -&gt; pd.Dataframe:
	...
	return load_data(df)</code></pre></div>
...
<div data-rt-embed-type="true"><pre><code fs-codehighlight-element="code">@step(experiment_tracker="mlflow")
def a_training_step(df: pd.Dataframe):
	train_model(df)</code></pre></div>
