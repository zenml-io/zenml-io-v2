...
<div data-rt-embed-type="true"><pre><code fs-codehighlight-element="code">import asyncio
import os
...
<ul id=""><li id="">"What pipeline runs failed in the last week?"</li><li id="">"Show me the artifacts from my most recent training pipeline"</li><li id="">"Which team members have been running experiments with the new dataset?"</li><li id="">"What's the status of my current pipeline runs?"</li><li id="">"Can you show me the logs from that failing step?"</li></ul>
