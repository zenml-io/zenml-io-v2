...
<ul id=""><li id="">the mode of the game was either all pick or all draft</li><li id="">the game was played by 10 human players (so no bots)</li><li id="">the game was won by either one of the teams</li><li id="">the game was either a normal game or a ranked game</li><li id="">the game was played during either patch 6.84 or patch 6.85 (getting rid of the infamous 'ho ho ha ha' patch)</li></ul>
