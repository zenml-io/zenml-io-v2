...
<ul start="1" id=""><li id=""><a target="_blank" href="https://www.hashicorp.com/" id="">Hashicorp</a> switches to the <a target="_blank" href="https://en.wikipedia.org/wiki/Business_Source_License" id="">BSL Licence</a> and promptly <a target="_blank" href="https://www.hashicorp.com/blog/hashicorp-joins-ibm" id="">gets acquired by IBM</a></li><li id=""><a target="_blank" href="https://redis.io/" id="">Redis</a> switches to "<a target="_blank" href="https://arstechnica.com/information-technology/2024/04/redis-license-change-and-forking-are-a-mess-that-everybody-can-feel-bad-about/" id="">Dual Source-Available</a>" licensing</li><li id="">In the MLOps community, model deployment tool <a target="_blank" href="https://www.seldon.io/strengthening-our-commitment-to-open-core" id="">Seldon switched to BSL</a></li></ul>
...
<ul start="1" id=""><li id="">Working with <a target="_blank" href="https://www.linkedin.com/in/gabitov/" id="">Renat Gabitov</a> and the team at <a target="_blank" href="https://www.linkedin.com/company/represent-studio/" id="">Represent</a>, we recorded a "<strong id="">Zero to Hero</strong>" video tutorial using ZenML.</li><li id="">The video is professionally edited and shot, and features yours truly. It took me two hours to shoot, and made me appreciate how tough being a full-time YouTuber can be!</li><li id="">Like and subscribe on YouTube to show the love!</li></ul>
