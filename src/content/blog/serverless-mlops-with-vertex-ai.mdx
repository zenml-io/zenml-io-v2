...
<ul id=""><li id=""><a href="https://www.python.org/" id="">Python</a> installed (version 3.7-3.9)</li><li id=""><a href="https://www.docker.com/" id="">Docker</a> installed and running</li><li id="">Access to a <a href="https://cloud.google.com/" id="">gcp</a> project space</li><li id=""><a href="https://cloud.google.com/sdk/gcloud" id="">gcloud CLI</a> installed on your machine and authenticated</li><li id=""><a href="https://docs.zenml.io/user-guide/starter-guide/switch-to-production" id="">Remote ZenML Server</a> A Remote Deployment of the ZenML HTTP server and Database</li></ul>
...
<ul id=""><li id="">The project name will be referred to as &lt;gcp_project_name&gt;</li><li id="">The <a href="https://support.google.com/googleapi/answer/7014113?hl=en" id="">project number</a> will be referred to as &lt;gcp_project_id&gt;</li></ul>
...
<ul id=""><li id="">Search secret manager or use this <a href="https://console.cloud.google.com/marketplace/product/google/secretmanager.googleapis.com" id="">link</a></li></ul>
...
</container_registry_uri></code></pre></div>
...
</service_account></gcp_location></project_id></code></pre></div>
