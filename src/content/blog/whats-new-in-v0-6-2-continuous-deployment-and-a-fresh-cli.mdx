...
<ul id=""><li id="">Ensure <em id="">quickstart</em> example code is identical across everywhere it is referenced.</li><li id="">Added core concepts back into the <a href="https://docs.zenml.io/" id="">main glossary</a> (sorted alphabetically and made concise).</li><li id="">Added <a href="https://docs.zenml.io/" id="">cloud-specific guide</a> for deploying pipelines.</li><li id="">Inside the codebase itself, removed some parameters specified in docstrings that no longer existed in code.</li><li id="">Various spelling and typo corrections.</li></ul>

## ➕ Other Updates, Additions and Fixes

<ul id=""><li id="">Our test suite is now more robust. We run our integration tests on kubeflow (as well as on the local stack), and integration tests run in separate virtual environments for each integration test.</li><li id="">We added <a href="https://github.com/zenml-io/zenml/pull/411" id="">some extra parts</a> to our PR template, which you’ll reach when you contribute to the ZenML codebase.</li><li id="">We fixed a bug where the CLI wasn’t working if you didn’t have git already installed. (This mainly applies to Windows machines, and our bug fix doesn’t apply to any of the zenml example… functionality, since that requires git.)</li><li id="">Added various logging and informative error messages for edge cases.</li><li id=""><a href="https://github.com/zenml-io/zenml/pull/416" id="">Fixed a bug</a> where an IPython REPL would crash when running examples or code that visualized data.</li><li id="">We now automatically activate integrations when we are unable to find stack components.</li><li id="">We now <a href="https://github.com/zenml-io/zenml/pull/390" id="">handle the failure</a> of workflows for cases where ModuleNotFound errors are raised.</li></ul>
