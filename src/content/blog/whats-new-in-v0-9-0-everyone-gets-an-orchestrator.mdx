...
<ul id=""><li id="">If you want to register a stack component but aren’t sure exactly which attributes to register for your particular component, we <a href="https://github.com/zenml-io/zenml/pull/695" id="">added an interactive CLI flow</a> that guides you through everything you need to include.</li></ul>
...
<ul id=""><li id="">We previously added the ability to update a pre-existing stack in place, but sometimes you want to duplicate a stack and make a slight modification to one you already configured. In this release we’ve given you that option with the easy zenml stack copy command.</li></ul>
...
<ul id=""><li id="">Schedules can now be defined using ‘cron’ expressions</li><li id="">The detection of whether a step was cached or not is now done without querying the metadata store. This reduces the step execution by ~10secs.</li><li id="">We now allow for the passing of authentication credentials to all artifact stores and container registries as secrets</li><li id="">We made the dependencies that are part of the ZenServer optional. If you wish to install the ZenServer, be sure to use the following command: pip install zenml[server].</li><li id="">We fixed some broken or deprecated CLI commands listed in our examples.</li><li id="">We made some internal changes to how code is organized within the core src/zenml directory, notably for the utils module and for all the cloud integrations.</li></ul>
...
<ul id=""><li id=""><a href="https://github.com/anencore94" id="">@anencore94</a> made their first contribution in <a href="https://github.com/zenml-io/zenml/pull/644" id="">https://github.com/zenml-io/zenml/pull/644</a></li><li id=""><a href="https://github.com/hectorLop" id="">@hectorLop</a> made their first contribution in <a href="https://github.com/zenml-io/zenml/pull/648" id="">https://github.com/zenml-io/zenml/pull/648</a></li><li id=""><a href="https://github.com/gabrielmbmb" id="">@gabrielmbmb</a> made their first contribution in <a href="https://github.com/zenml-io/zenml/pull/640" id="">https://github.com/zenml-io/zenml/pull/640</a></li><li id=""><a href="https://github.com/ketangangal" id="">@ketangangal</a> made their first contribution in <a href="https://github.com/zenml-io/zenml/pull/628" id="">https://github.com/zenml-io/zenml/pull/628</a></li><li id=""><a href="https://github.com/Reed-Schimmel" id="">@Reed-Schimmel</a> made their first contribution in <a href="https://github.com/zenml-io/zenml/pull/684" id="">https://github.com/zenml-io/zenml/pull/684</a></li></ul>
