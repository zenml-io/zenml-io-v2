...
<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/4b6568c7/655634b7d30cb780727ae038_pipelines_overview.png" alt="Overview of the four ZenML pipelines: feature engineering, training, promotion, and deployment to Sagemaker" />
</figure>
...
<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/e982b21f/6556353a385b46aa9bbb543d_pipelines_feature_eng.png" alt="Feature engineering pipeline that loads Huggingface data and tokenizes it into a versioned dataset" />
</figure>
...
<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/01c3fb83/6556276e837f48a1862d831f_training_pipeline_overview.png" alt="Training pipeline with the local MLOps stack on the left and the ZenML Model Control Plane on the right" />
</figure>
...
<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/890bf91d/655635a42cb69eee96efaacf_mcp_2.png" alt="ZenML Cloud Model Control Plane view consolidating all artifacts for a machine learning model" />
</figure>
...
<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/555f0759/655635ba8364e8a5e4e693a3_hf_repo_commit.png" alt="Huggingface Hub repository showing a commit created automatically by the ZenML training pipeline" />
  <figcaption>Notice that the pipeline creates a commit on Huggingface Hub automatically</figcaption>
</figure>

<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/bc4ff47d/655635db6f42324843741d98_training_pipeline_with_hf.png" alt="ZenML tracking the same Huggingface Hub commit revision to establish model lineage" />
...
<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/91ad41d7/65563624cecadcbf0affcb72_promoting_pipeline_overview.png" alt="Promotion pipeline comparing model metrics and marking the best one as production ready" />
</figure>
...
<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/bc9cd5ea/65563639cdc36d997045cef0_deploying_pipeline_overview.png" alt="Deployment pipeline pushing the production model to a live AWS Sagemaker endpoint" />
</figure>
...
<figure>
  <img src="https://assets.zenml.io/webflow/64a817a2e7e2208272d1ce30/bfde3f0a/6556365ff4454f14a81e3035_nlp_zenml_demo.png" alt="Gradio demo app running sentiment analysis against the deployed Sagemaker endpoint" />
</figure>
