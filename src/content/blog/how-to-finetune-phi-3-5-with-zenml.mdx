...
<ul id=""><li id="">Great performance for their size</li><li id="">Ideal for use on-device</li><li id="">Trained on high-quality data, with a synthetic textbook-style flavor</li><li id="">Strong instruction tuning (they don't get released as base models)</li></ul>
...
<div data-rt-embed-type="true"><pre><code>zenml stack deploy -n phi35-starter -p gcp --set
</code></pre></div>
...
<div data-rt-embed-type="true"><pre><code>python run.py --config phi3.5_finetune_remote.yaml
</code></pre></div>
