...
<ul id=""><li id="">Faster iteration and development</li><li id="">No need to register a code repository for build reuse</li><li id="">Builds only occur when requirements or <code id="">DockerSettings</code> change</li></ul>
...
<ul id=""><li id="">Automated infrastructure setup for ZenML stack deployment</li><li id="">Streamlined registration of configurations to the ZenML server</li></ul>
