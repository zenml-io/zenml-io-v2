...
<ul id=""><li id="">A great team (experienced ML engineers, Ops expertise and a good entrepreneurial fit)</li><li id="">A purpose-built tech stack for reproducible ML pipelines</li><li id="">Experience running small and large projects</li><li id="">A good network of other startups and developers in ML-related positions across the globe</li></ul>
