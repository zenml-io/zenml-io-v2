...
<div data-rt-embed-type="true"><div class="table-container">
  <table>
    <thead>
      <tr>
        <th>ZenML Controls</th>
        <th>The Agent Controls</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>Fan-out (spawn N agents based on runtime data)</td>
        <td>"Does this document answer the query?"</td>
      </tr>
      <tr>
        <td>Budget and depth limits</td>
        <td>"Should I traverse deeper?"</td>
      </tr>
      <tr>
        <td>Step orchestration and DAG construction</td>
        <td>Natural language reasoning about next steps</td>
      </tr>
      <tr>
        <td>Artifact tracking and lineage</td>
        <td>Which documents to explore next</td>
      </tr>
      <tr>
        <td>Failure handling per step (retries, fallbacks)</td>
        <td></td>
      </tr>
    </tbody>
  </table>
...
<div data-rt-embed-type="true"><pre><code fs-codehighlight-element="code"># Get count for loop bounds (runtime value)
...
<div data-rt-embed-type="true"><pre><code fs-codehighlight-element="code">max_agents = min(max(max_agents, 1), 10)
...
<div data-rt-embed-type="true"><pre><code fs-codehighlight-element="code">for idx in range(min(2, len(traverse_to_data))):
