...
<ul id=""><li id="">Ankur Tyagi wrote a post for the MLOps Community blog in which he tackled the comparison between <a href="https://home.mlops.community/public/blogs/zenml-vs-flyte-vs-metaflow" id="">ZenML vs Flyte vs Metaflow</a></li><li id="">Sam Ozturk wrote about <a href="https://themeansquare.medium.com/getting-started-with-zenml-building-production-ready-ml-pipelines-17dff6500957" id="">getting started with ZenML</a> on his Medium blog</li><li id="">Over on the Londogard blog we read another comparison piece, this time <a href="https://blog.londogard.com/posts/2024-05-05-zenml-vs-clearml/" id="">ZenML vs ClearML</a> with the conclusion that "If you prefer to keep your stack as simple as possible: ClearML. If you prefer to keep your stack customized having the best tool for each part: ZenML."</li><li id="">Jordan Brown wrote about a ZenML-driven <a href="https://www.33rdsquare.com/mlops-employee-attrition-rate-prediction-using-zenml-and-streamlit/" id="">employee attrition pipeline</a> that used Streamlit to create a web application on top of the prediction model that gets trained.</li><li id="">Finally we had <a href="https://www.youtube.com/watch?v=XMwHrhIjYrU" id="">a very neat video demo of an end-to-end LLM finetuning pipeline</a> from Kushwanth K which leverages Unsloth, MLflow and DagsHub.</li></ul>
...
<ul id=""><li id="">Anthropic's '<a href="https://www.anthropic.com/research/building-effective-agents" id="">Building effective agents</a>' gave us lots of food for thought around when to use agents as well as some vocabulary around the architectures that make sense.</li><li id="">Chip Huyen published <a href="https://huyenchip.com//2025/01/07/agents.html" id="">her own take on agents</a> which is in turn an excerpt from <a href="https://www.amazon.com/AI-Engineering-Building-Applications-Foundation/dp/1098166302?language=en_US&amp;ref_=as_li_ss_tl&amp;linkCode=sl1&amp;tag=soumet-20&amp;linkId=01816c7d3ddfbc9515349562c9b55eae" id="">her new book 'AI Engineering'</a>. Chip also released a blog around some <a href="https://huyenchip.com/2025/01/16/ai-engineering-pitfalls.html" id="">common pitfalls when building GenAI applications</a>, of which the first probably needs saying the most often: "[Don't] use generative AI when you don't need generative AI."</li><li id="">Over at Hugging Face, Margaret Mitchell and a few others published <a href="https://huggingface.co/blog/ethics-soc-7" id="">their perspective on the ethical tradeoffs</a> and risks around the deployment of agents. TLDR: "risks to people increase with a system’s level of autonomy: the more control a user cedes, the more risks arise from the system".</li></ul>
