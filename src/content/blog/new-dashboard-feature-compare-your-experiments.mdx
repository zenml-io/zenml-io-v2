...
<div data-rt-embed-type="true"><div style="position: relative; padding-bottom: 65.81352833638026%; height: 0;"><iframe src="https://www.loom.com/embed/693b2d829600492da7cd429766aeba6a?sid=fa4cd579-2dc7-452b-9698-8a92e50fe9fe" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div></div>
...
<ul id=""><li id="">Clear tabular presentation of sequential pipeline runs</li><li id="">Automatic comparative analysis between runs</li><li id="">Key run metadata (model, stack, start time, run executor) presented alongside your custom metadata</li></ul>
...
<ol id=""><li id="">Configure your pipelines to log numerical metadata</li><li id="">Access the dashboard through your Pro account</li><li id="">Select your pipeline runs</li><li id="">Explore both visualization modes to uncover insights</li></ol>
...
<div data-rt-embed-type="true"><pre><code>from zenml import step, pipeline, log_metadata, Model
...
rocket_telemetry_pipeline()</code></pre></div>
