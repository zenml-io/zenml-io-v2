...
<ul id=""><li id="">Meta introduced <a href="https://arxiv.org/pdf/2404.08801.pdf" id="">MEGALODON</a>, a neural architecture designed for efficient sequence modeling with unlimited context length, which may be used in their upcoming Llama 3 model.</li><li id="">Google researchers proposed <a href="https://arxiv.org/pdf/2404.09173.pdf" id="">Infini-Attention and Feedback Attention Memory (FAM)</a> methods to enable Transformers to handle infinitely long contexts with bounded memory and computation.</li><li id="">Microsoft Research developed <a href="https://github.com/jshuadvd/LongRoPE" id="">LongRoPE</a>, extending LLM context window to over 2 million tokens, and RHO-1, which uses Selective Language Modeling (SLM) to focus on desired tokens during pre-training.</li><li id="">NVIDIA researchers created <a href="https://arxiv.org/pdf/2404.06654.pdf" id="">RULER</a>, a benchmark to evaluate the efficiency of long-context language models across various task categories.</li></ul>
...
<ul id=""><li id="">you split your text data into small chunks (optionally attaching metadata alongside)</li><li id="">you encode your chunks as vectors (helped by pre-made embedding models) and store them somewhere</li><li id="">when you’re ready to use your RAG system, you encode a question as a vector and find other vectors that are similar.</li><li id="">you take the most relevant handful of those context chunks and pass them to the LLM along with the original question to get a response to your question</li></ul>
