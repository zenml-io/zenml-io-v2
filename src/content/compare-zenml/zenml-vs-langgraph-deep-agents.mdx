...
LangGraph models an agent as a graph: nodes, edges, and state that persists across steps, with checkpointers for durability and Deep Agents layering planning and sub-agents on top. Behind it sits a packaged path to production through LangSmith Deployment (formerly LangGraph Platform) and LangSmith tracing, which handle deployment, persistence, and observability for you.
...
<ComparisonTable
  competitorLabel="LangGraph & Deep Agents"
  rows={[
    { feature: "Artifacts and run data stay in your own infrastructure", zenml: true, competitor: "partial", note: "ZenML writes to your bucket by default. LangSmith Deployment self-hosting is an Enterprise-plan option." },
    ...
    { feature: "Isolated environment for generated code", zenml: true, competitor: "partial", note: "ZenML: the sandbox stack component. LangGraph: LangSmith Sandboxes, part of the LangSmith platform." },
    ...
    { feature: "Open source, self-hostable", zenml: true, competitor: "partial", note: "LangGraph is open source; LangSmith Deployment self-hosting sits on the Enterprise plan." },
  ]}
/>
