...
They don&rsquo;t compete. They compose. Kitaru ships a [first-class Pydantic AI adapter](https://docs.zenml.io/kitaru) that tracks model requests and tool calls as child events under the enclosing checkpoint.
