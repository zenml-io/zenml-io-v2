...
order: 50
ogImage: "https://assets.zenml.io/compare/kitaru-og/kitaru-vs-pydantic-ai/3e77caad/kitaru-vs-pydantic-ai.jpg"
---
...
They don&rsquo;t compete. They compose. Kitaru ships a [first-class Pydantic AI adapter](https://kitaru.ai/docs/guides/pydantic-ai-adapter) that tracks model requests and tool calls as child events under the enclosing checkpoint.
