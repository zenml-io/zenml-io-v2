...
export const PRICING_STATS = {
  ...
  testimonial: {
    ...
    companyLogo: `${WEBFLOW_CDN}/6532977ff6458771fb59387e_hashicorp.webp`,
  },
  logos: [
    { src: `${WEBFLOW_CDN}/652d3ecd4d162d2290427dfe_airbus_defence_space.png`, alt: "Airbus" },
    { src: `${WEBFLOW_CDN}/66c84308916684f0d07b57ff_axa-min.svg`, alt: "AXA" },
    { src: `${WEBFLOW_CDN}/bundeswehr.svg`, alt: "Bundeswehr" },
    { src: `${WEBFLOW_CDN}/66c84308b1e802ab9a246134_enel-min.svg`, alt: "Enel" },
    { src: `${WEBFLOW_CDN}/jetbrains-min.svg`, alt: "JetBrains" },
    { src: `${WEBFLOW_CDN}/652d3e5d29d36f927c2bb623_brevo.webp`, alt: "Brevo" },
    { src: `${WEBFLOW_CDN}/cross-screen-media.png`, alt: "Cross Screen Media" },
    { src: `${WEBFLOW_CDN}/65c498032806e2ff7daec2bf_ADEO.svg`, alt: "ADEO" },
    { src: `${WEBFLOW_CDN}/65c49832a235dab4e3e0a3ce_leroy-merlin.svg`, alt: "Leroy Merlin" },
    { src: `${WEBFLOW_CDN}/652d3ecc040ac25a545c508f_rivian.png`, alt: "Rivian" },
    { src: `${WEBFLOW_CDN}/66c84308abf004bb1934e7d3_mann-hummel-min.svg`, alt: "Mann+Hummel" },
    { src: `${WEBFLOW_CDN}/koble.svg`, alt: "Koble" },
  ],
} as const;
