...
export const DEPLOYMENTS_SCENARIOS = [
  {
    ...
    image: {
      url: `${WEBFLOW_CDN}/local-deployments.png`,
  ...
  },
  {
    ...
    image: {
      url: `${WEBFLOW_CDN}/local_full.png`,
  ...
  },
  {
    ...
    image: {
      url: `${WEBFLOW_CDN}/02_pro_saas.png`,
...
export const DEPLOYMENTS_METHODS = [
  {
    ...
    icon: `${WEBFLOW_CDN}/667037da03e4569db6e31135_zenml_icon.webp`,
    iconAlt: "ZenML icon",
  },
  {
    title: "Docker",
    ...
    icon: `${WEBFLOW_CDN}/docker-icon-min.svg`,
    iconAlt: "Docker",
  },
  {
    title: "Helm",
    ...
    icon: `${WEBFLOW_CDN}/kubernetes.png`,
    iconAlt: "Kubernetes",
  },
  {
    ...
    icon: `${WEBFLOW_CDN}/65df144133e3478a8bf66cd3_hugging-face-min.svg`,
  ...
  tabs: [
    {
      ...
      image: {
        url: `${WEBFLOW_CDN}/deployment_diagram_1.png`,
    ...
    },
    {
      ...
      image: {
        url: `${WEBFLOW_CDN}/deployment_diagram_2.png`,
    ...
    },
    {
      ...
      image: {
        url: `${WEBFLOW_CDN}/deployment_diagram_3.png`,
