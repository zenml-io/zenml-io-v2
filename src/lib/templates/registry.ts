...
export const TEMPLATE_REGISTRY: readonly TemplateEntry[] = [
  ...
  },
  {
    ...
    paperPage: 0,
    notes:
      'ZenML Labs homepage section 05: headline + "all case studies" link, then four shared LabsStoryCards (customer logos on light sage grain, title, read-the-story label). Content arrives through `content: StoryCardsContent` (LABS_STORIES on `/`, cards from CASE_STUDY_CARDS); the first four cards render.',
    contentShape: {
      minItems: 4,
      maxItems: 4,
      oddCount:
  ...
  },
  {
    ...
    paperPage: 4,
    notes:
      "Shared customer-logo card for homepage stories, case-study index and sibling rail. Light sage gradient with subtle static grain; title reuses the blog card typography.",
    stage: false,
    demoProps: {},
  },
  {
  ...
  },
  {
    ...
    paperPage: 0,
    notes:
      "Shared body-bound breadcrumb: desktop top108 with prose-width fade, static below lg. Never a reveal target.",
    stage: false,
    demoProps: {},
  },
  {
