      ...
      subtabs: [
        {
          ...
          rows: [
            { initial: "C", initialTone: "purple" as const, name: "churn_training", meta: "v32 · 8 steps · 4m 12s · ✓ completed", target: "Kubernetes", selected: true },
            { initial: "F", initialTone: "dark" as const, name: "fraud_detection", meta: "v18 · 12 steps · 11m 04s", target: "Kubeflow" },
            { initial: "S", initialTone: "purple-300" as const, name: "sentiment_classifier", meta: "v44 · 9 steps · 47m 21s", target: "Vertex AI" },
            { initial: "I", initialTone: "dark" as const, name: "image_segmentation", meta: "v07 · 6 steps · 4m 18s", target: "SageMaker" },
            { initial: "R", initialTone: "purple-300" as const, name: "recsys_nightly", meta: "v03 · 14 steps · 3h 12m", target: "Airflow" },
          ],
          fileName: "churn_training.py",
          rightEyebrow: "Same pipeline · three destinations",
          rightSubhead: "Reproducible ML — laptop to production.",
          ...
          footerMeta: "Stack: kubernetes-prod · 12 pods · 4m 12s",
        },
        {
          ...
          lineageDetail: "step that produced this",
        ...
        },
        {
          ...
          surfaceTitle: "Stacks",
          surfaceSubtitle: "Same pipeline · three destinations — swap any layer",
          /** Sidecar header copy for the left panel. */
          title: "Registered stacks",
          subtitle: "Same pipeline · three destinations",
          countLabel: "12 total",
        ...
        },
        {
          ...
          envStripEyebrow: "Where it runs · one registry, every env",
        ...
        },
        {
          ...
          surfaceSubtitle: "Plug in any orchestrator, store, tracker, or alerter — 60+ supported",
          title: "Installed",
          subheader: "5 active · 60+ available",
          rows: [
          ...
          rightEyebrow: "Native to your stack",
          ...
          footerMeta: "5 of 60+ installed · last updated 1 week ago",
        },
      ],
    },
    {
      ...
      subtabs: [
        {
          ...
          countLabel: "2 decorators · 0 boilerplate",
          rows: [
          ...
          footerMeta: "Runtime: kubernetes · 2 checkpoints · 2m 14s",
        },
        {
          ...
          surfaceSubtitle: "Resume from any checkpoint. Never start over.",
          title: "Recent runs",
          ...
          rightSubhead: "Resume from any checkpoint. Never start over.",
        ...
        },
        {
          ...
          surfaceTitle: "Replay",
          surfaceSubtitle: "Replay, don't guess — evidence-backed prompt/model variant comparison",
          title: "Frozen packs",
          ...
          rightEyebrow: "Replay · 400 runs · 11s",
          headline: "Replay, don't guess.",
          subhead: "Rerun September against v18·rc2. Ship the variant the numbers picked.",
          ...
          replayedLabel: "400 / 400 replayed · 11s",
          steps: [
            ...
            { name: "tool:search", baseline: { dur: "1.1s", cost: "—", tokens: "—" }, candidate: { dur: "0.7s", cost: "—", tokens: "—" }, deltas: { dur: "−36%" } },
            ...
            { name: "llm:summarize", baseline: { dur: "1.8s", cost: "$0.002", tokens: "0.8K" }, candidate: { dur: "0.6s", cost: "$0.001", tokens: "0.4K" }, deltas: { dur: "−67%", cost: "−50%", tokens: "−50%" } },
          ],
          verdictEyebrow: "DECISION · evidence-backed",
          verdictHeadline: "Ship v18·rc2. The numbers picked.",
          verdictSummary: "+8.7pt completion · −44% tool calls · −37% latency · −34% cost",
        ...
        },
        {
          ...
          rightSubhead: "One runtime. Your substrate.",
          ...
          podsActive: 12,
          podsTotal: 16,
          footerMeta: "Runtime layer is portable · pods are substrate",
        },
        {
          id: "integrations" as const,
          label: "Integrations",
          ...
          surfaceTitle: "Integrations",
          surfaceSubtitle: "Framework-agnostic — wrap any inner loop you like",
          title: "Frameworks",
          subheader: "Wrap any inner loop you like",
          countLabel: "@flow + your code",
          rows: [
          ...
          rightEyebrow: "Framework-agnostic · keep your inner loop",
          ...
          wrapRight: "checkpoint · resume · wait",
          ...
          swapEyebrow: "Swap inner loop",
          swapCaption: "No re-write of @flow",
          swapChips: [
          ...
          footerMeta: "5 frameworks · Anthropic SDK active · loop swap is one line",
        },
      ],
    },
  ],
