...
export const FLOW_EXAMPLES: ReadonlyArray<FlowExample> = [
  {
    ...
    timeline: {
      spans: [
        { name: "research_agent", type: "flow", durationLabel: "1m 47s · live", durationSeconds: 107, state: "running", indent: 0, leftPct: 0, widthPct: 100, parent: true },
        { name: "gather_sources", type: "tool", durationLabel: "42s", durationSeconds: 42, state: "completed", indent: 1, leftPct: 0, widthPct: 39 },
        { name: "chkpt.notes", type: "checkpoint", durationLabel: "0.3s", durationSeconds: 0.3, state: "completed", indent: 1, leftPct: 39, widthPct: 0.5 },
        { name: "summarize", type: "llm", durationLabel: "65s · live", durationSeconds: 65, state: "running", indent: 1, leftPct: 39.5, widthPct: 60.5 },
      ],
  ...
  },
  {
    ...
    timeline: {
      spans: [
        { name: "llm_writer", type: "flow", durationLabel: "11s", durationSeconds: 11, state: "completed", indent: 0, leftPct: 0, widthPct: 100, parent: true },
        { name: "outline_call", type: "llm", durationLabel: "4.1s", durationSeconds: 4.1, state: "completed", indent: 1, leftPct: 0, widthPct: 37 },
        { name: "chkpt.outline", type: "checkpoint", durationLabel: "0.2s", durationSeconds: 0.2, state: "completed", indent: 1, leftPct: 37, widthPct: 0.5 },
        { name: "draft_call", type: "llm", durationLabel: "6.5s", durationSeconds: 6.5, state: "completed", indent: 1, leftPct: 37.5, widthPct: 59 },
        { name: "chkpt.draft", type: "checkpoint", durationLabel: "0.2s", durationSeconds: 0.2, state: "completed", indent: 1, leftPct: 96.5, widthPct: 0.5 },
      ],
  ...
  },
  {
    ...
    timeline: {
      spans: [
        { name: "audit_company", type: "flow", durationLabel: "6m 18s", durationSeconds: 378, state: "running", indent: 0, leftPct: 0, widthPct: 100, parent: true },
        { name: "check_hr_compliance", type: "llm", durationLabel: "58s", durationSeconds: 58, state: "completed", indent: 1, leftPct: 0, widthPct: 15.3 },
        { name: "check_it_security", type: "llm", durationLabel: "1m 12s", durationSeconds: 72, state: "completed", indent: 1, leftPct: 15.3, widthPct: 19 },
        { name: "check_vendor_contracts", type: "llm", durationLabel: "1m 36s", durationSeconds: 96, state: "completed", indent: 1, leftPct: 34.3, widthPct: 25.4 },
        { name: "check_insurance", type: "llm", durationLabel: "47s", durationSeconds: 47, state: "completed", indent: 1, leftPct: 59.7, widthPct: 12.4 },
        { name: "chkpt.findings", type: "checkpoint", durationLabel: "0.5s", durationSeconds: 0.5, state: "completed", indent: 1, leftPct: 72.1, widthPct: 0.5 },
        { name: "synthesize_report", type: "llm", durationLabel: "1m 45s · live", durationSeconds: 105, state: "running", indent: 1, leftPct: 72.6, widthPct: 27.4 },
      ],
  ...
  },
  {
    ...
    timeline: {
      spans: [
        { name: "wait_for_approval_flow", type: "flow", durationLabel: "2m 04s + paused", durationSeconds: 124, state: "running", indent: 0, leftPct: 0, widthPct: 100, parent: true },
        { name: "draft_release_note", type: "tool", durationLabel: "8s", durationSeconds: 8, state: "completed", indent: 1, leftPct: 0, widthPct: 6 },
        { name: "chkpt.draft", type: "checkpoint", durationLabel: "0.2s", durationSeconds: 0.2, state: "completed", indent: 1, leftPct: 6, widthPct: 0.5 },
        { name: "wait.approve_release", type: "llm", durationLabel: "awaiting input", durationSeconds: null, state: "running", indent: 1, leftPct: 6.5, widthPct: 78 },
        { name: "publish_release_note", type: "tool", durationLabel: "queued", durationSeconds: null, state: "queued", indent: 1, leftPct: 84.5, widthPct: 15.5 },
      ],
      axisTicks: ["0s", "30s", "1m", "1m30s", "2m"],
  ...
  },
  {
    ...
    timeline: {
      spans: [
        { name: "news_scout", type: "flow", durationLabel: "3m 22s", durationSeconds: 202, state: "completed", indent: 0, leftPct: 0, widthPct: 100, parent: true },
        { name: "agent.plan", type: "llm", durationLabel: "8s", durationSeconds: 8, state: "completed", indent: 1, leftPct: 0, widthPct: 4 },
        { name: "search_news", type: "tool", durationLabel: "21s", durationSeconds: 21, state: "completed", indent: 1, leftPct: 4, widthPct: 10.4 },
        { name: "search_twitter", type: "tool", durationLabel: "18s", durationSeconds: 18, state: "completed", indent: 1, leftPct: 4, widthPct: 9 },
        { name: "investigate", type: "tool", durationLabel: "1m 02s", durationSeconds: 62, state: "completed", indent: 1, leftPct: 14.4, widthPct: 30.7 },
        { name: "fetch_url", type: "tool", durationLabel: "11s", durationSeconds: 11, state: "completed", indent: 1, leftPct: 45.1, widthPct: 5.4 },
        { name: "agent.summarize", type: "llm", durationLabel: "1m 18s", durationSeconds: 78, state: "completed", indent: 1, leftPct: 50.5, widthPct: 38.6 },
        { name: "publish_report", type: "checkpoint", durationLabel: "0.4s", durationSeconds: 0.4, state: "completed", indent: 1, leftPct: 99, widthPct: 0.5 },
      ],
