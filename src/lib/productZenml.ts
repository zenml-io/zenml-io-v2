...
export const PRODUCT_ZENML_HERO = {
  ...
  subtitle:
    "Orchestrate any AI workflow — training, batch inference, evals, agents — from your laptop to Kubernetes, Vertex, SageMaker, and AzureML. Reproducible artifacts, model registry, and a composable stack — without vendor lock-in.",
